...
$app_list_strings['moduleList']['PhoneCalls'] = 'Телефонные звонки';
...
$app_list_strings['phonecalls_status_list'] = array(
    ...
    'ANSWER' => 'Ответ',
    'BUSY' => 'Занято',
    'CANCEL' => 'Отмена вызова',
    'NOANSWER' => 'Нет ответа',
    'UNKNOWN' => 'Не определён',
    'CHANUNAVAIL' => 'Ошибка (канал недоступен)',
    'CONGESTION' => 'Ошибка (перегрузка)',
    'DONTCALL' => 'Ошибка (не звонить)',
    'INVALIDARGS' => 'Ошибка (неправильные аргументы)',
    'TORTURE' => 'Ошибка (torture)',
);
...
$app_list_strings['lm_faxman_category_dom']['Marketing'] = 'Маркетинг';
$app_list_strings['lm_faxman_category_dom']['Knowledege Base'] = 'База знаний';
$app_list_strings['lm_faxman_category_dom']['Sales'] = 'Продажи';
$app_list_strings['lm_faxman_subcategory_dom'][''] = '';
$app_list_strings['lm_faxman_subcategory_dom']['Marketing Collateral'] = 'Маркетинг';
$app_list_strings['lm_faxman_subcategory_dom']['Product Brochures'] = 'Брошюры товаров';
$app_list_strings['lm_faxman_subcategory_dom']['FAQ'] = 'ЧаВо';
$app_list_strings['lm_faxman_status_dom']['Active'] = 'Активен';
$app_list_strings['lm_faxman_status_dom']['Draft'] = 'Черновик';
$app_list_strings['lm_faxman_status_dom']['FAQ'] = 'ЧаВо';
$app_list_strings['lm_faxman_status_dom']['Expired'] = 'Просрочен';
$app_list_strings['lm_faxman_status_dom']['Under Review'] = 'Рассматривается';
$app_list_strings['lm_faxman_status_dom']['Pending'] = 'Ожидание решения';
