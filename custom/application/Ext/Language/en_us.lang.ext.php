...
$app_list_strings['moduleList']['PhoneCalls'] = 'Phone calls';
$app_list_strings['phonecalls_direction_list'] = array(
    '' => '',
    0 => 'Incoming',
    1 => 'Outcoming',
);

$app_list_strings['phonecalls_status_list'] = array(
    'CALLING' => 'Calling',
    'ANSWER' => 'Answer',
    'BUSY' => 'Busy',
    'CANCEL' => 'Cancel',
    'NOANSWER' => 'No answer',
    'UNKNOWN' => 'Unknown',
    'CHANUNAVAIL' => 'Error (chanel unavailable)',
    'CONGESTION' => 'Error (congestion)',
    'DONTCALL' => 'Error (do not call)',
    'INVALIDARGS' => 'Error (invalid arguments)',
    'TORTURE' => 'Error (torture)',
);
$app_list_strings['cti_preset_list'] = array(
    'android' => 'Android',
    //'cti' => 'CTI',
);


$app_list_strings['account_source_dom'] = array(
    '' => '',
    'EmailMarketing' => 'Электронная рассылка',
    'DirectMail' => 'Директ-мэйл',
    'FaxMessaging' => 'Факсимильная рассылка',
    'Recommendations' => 'Рекомендации',
    'FaceBook' => 'Клиент из FaceBook',
    'ExistingAccount' => 'Старый клиент',
    'SiteVisitor' => 'Клиент с сайта'
);
...
$app_list_strings['moduleList']['SYNO_Pdf_templates'] = 'Templates PDF';
$app_list_strings['SYNO_GLO_YES_NO']['yes'] = 'Yes';
$app_list_strings['SYNO_GLO_YES_NO']['no'] = 'No';

$app_strings['SYNO_PDF_TEMPLATES_BUTTON'] = 'PDF';
...
$app_list_strings['moduleList']['lm_TechnicalSupport'] = 'Техническая поддержка';
$app_list_strings['lm_priority_list']['low'] = 'Низкий';
$app_list_strings['lm_priority_list']['average'] = 'Средний';
$app_list_strings['lm_priority_list']['high'] = 'Высокий';
$app_list_strings['lm_ts_status_list']['new'] = 'Новое';
$app_list_strings['lm_ts_status_list']['in_process'] = 'В обработке';
$app_list_strings['lm_ts_status_list']['answer'] = 'Есть ответ';
$app_list_strings['lm_ts_status_list']['decision_expectation'] = 'Ожидание решения';
$app_list_strings['lm_ts_status_list']['closed'] = 'Закрыто';
$app_list_strings['lm_ts_type_list']['new_functions'] = 'Разработка нового функционала';
$app_list_strings['lm_ts_type_list']['updating'] = 'Подправить существующий функионал';
$app_list_strings['lm_ts_type_list']['current_work'] = 'Корректировка текущего этапа внедрения';
$app_list_strings['lm_ts_type_list']['guarantee'] = 'Гарантийные обязательства';
$app_list_strings['lm_ts_type_list']['financial_questions'] = 'Финансовые вопросы';
$app_list_strings['lm_ts_type_list']['other'] = 'Другое';
$app_list_strings['lm_ts_request_status_list']['sending_expectation'] = 'Ожидает отправки';
$app_list_strings['lm_ts_request_status_list']['is_sent'] = 'Отправлен';
$app_list_strings['lm_ts_request_status_list']['sending_error'] = 'Ошибка отправки';
$app_list_strings['lm_ts_request_status_list']['answer_expectation'] = 'Ожидание ответа';
$app_list_strings['lm_ts_payment_list']['none'] = 'Нет';
$app_list_strings['lm_ts_payment_list']['partially'] = 'Частично';
$app_list_strings['lm_ts_payment_list']['full'] = 'Оплачено';
$app_list_strings['lm_ts_payment_list']['not_provided'] = 'Не предусмотрено';
$app_list_strings['lm_ts_status_work_list']['none'] = 'Не начато';
$app_list_strings['lm_ts_status_work_list']['in_work'] = 'В работе';
$app_list_strings['lm_ts_status_work_list']['postponed'] = 'Отложено';
$app_list_strings['lm_ts_status_work_list']['verify'] = 'Необходимо проверить';
$app_list_strings['lm_ts_status_work_list']['completion'] = 'Отправлено на доработку';
$app_list_strings['lm_ts_status_work_list']['closed'] = 'Все выполнено';
$app_list_strings['lm_ts_cost_type_list']['none'] = 'Не определено';
$app_list_strings['lm_ts_cost_type_list']['free'] = 'Бесплатно';
$app_list_strings['lm_ts_cost_type_list']['fix'] = 'Сдельно';
$app_list_strings['lm_ts_cost_type_list']['time'] = 'Повременная оплата';
...
$app_list_strings['discount_list']['Amount'] = 'Amount';
...
$app_list_strings['moduleList']['lm_FaxMan'] = 'Рассылка факсов';
$app_list_strings['lm_faxman_category_dom'][''] = '';
$app_list_strings['lm_faxman_category_dom']['Marketing'] = 'Marketing';
$app_list_strings['lm_faxman_category_dom']['Knowledege Base'] = 'Knowledge Base';
$app_list_strings['lm_faxman_category_dom']['Sales'] = 'Sales';
$app_list_strings['lm_faxman_subcategory_dom'][''] = '';
$app_list_strings['lm_faxman_subcategory_dom']['Marketing Collateral'] = 'Marketing Collateral';
$app_list_strings['lm_faxman_subcategory_dom']['Product Brochures'] = 'Product Brochures';
$app_list_strings['lm_faxman_subcategory_dom']['FAQ'] = 'FAQ';
$app_list_strings['lm_faxman_status_dom']['Active'] = 'Active';
$app_list_strings['lm_faxman_status_dom']['Draft'] = 'Draft';
$app_list_strings['lm_faxman_status_dom']['FAQ'] = 'FAQ';
$app_list_strings['lm_faxman_status_dom']['Expired'] = 'Expired';
$app_list_strings['lm_faxman_status_dom']['Under Review'] = 'Under Review';
$app_list_strings['lm_faxman_status_dom']['Pending'] = 'Pending';
