<?php /* Smarty version 2.6.11, created on 2014-08-22 19:08:16
         compiled from modules/Campaigns/WizardMarketing.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Campaigns/WizardMarketing.html', 123, false),array('function', 'sugar_getscript', 'modules/Campaigns/WizardMarketing.html', 436, false),)), $this); ?>
<!--
/*********************************************************************************
...
"><?php echo $this->_tpl_vars['SCOPE_OPTIONS']; ?>
			...
			<td  NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_START_EMAIL_OUTBOUND_COUNTER']; ?>
</slot></td>
			<td><slot><input type="text" name="start_email_outbound_conter" value="<?php echo $this->_tpl_vars['START_EMAIL_OUTBOUND_COUNTER']; ?>
"></slot></td>
		</tr>
        <tr>
            <td>Отправить письма с указанного почтового ящика:</td>
            <td><input type="checkbox" name="custom_email_enabled" id="custom_email_enabled" <?php echo $this->_tpl_vars['CUSTOM_EMAIL_ENABLED']; ?>
></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>SMTP-сервер:</td>
            <td><input type="text" name="custom_email_smtp_server" id="custom_email_smtp_server" value="<?php echo $this->_tpl_vars['CUSTOM_EMAIL_SMTP_SERVER']; ?>
"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
                <tr>
                    <td>SMTP-порт:</td>
                    <td><input type="text" name="custom_email_smtp_port" id="custom_email_smtp_port" value="<?php echo $this->_tpl_vars['CUSTOM_EMAIL_SMTP_PORT']; ?>
"></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Включить SMTP over SSL/TLS:</td>
                    <td><select name="custom_email_protocol" id="custom_email_protocol"><?php echo $this->_tpl_vars['CUSTOM_EMAIL_PROTOCOL_OPTIONS']; ?>
</select></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" name="custom_email_username" id="custom_email_username" value="<?php echo $this->_tpl_vars['CUSTOM_EMAIL_USERNAME']; ?>
"></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Пароль:</td>
                    <td><input type="password" name="custom_email_password" id="custom_email_password" value="<?php echo $this->_tpl_vars['CUSTOM_EMAIL_PASSWORD']; ?>
"></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        $(\'#custom_email_enabled\').change(function(){
            showCustomSMTP();
        });
        showCustomSMTP();
    });

    function showCustomSMTP() {
        if($("#custom_email_enabled").is(":checked")) {
            // Если галка кастомного SMTP включена
            // Отображаем все поля
            $("#custom_email_smtp_server").closest(\'tr\').show();
            $("#custom_email_smtp_port").closest(\'tr\').show();
            $("#custom_email_protocol").closest(\'tr\').show();
            $("#custom_email_username").closest(\'tr\').show();
            $("#custom_email_password").closest(\'tr\').show();
        } else {
            // Если галка кастомного SMTP выключена
            // Скрываем все поля
            $("#custom_email_smtp_server").closest(\'tr\').hide();
            $("#custom_email_smtp_port").closest(\'tr\').hide();
            $("#custom_email_protocol").closest(\'tr\').hide();
            $("#custom_email_username").closest(\'tr\').hide();
            $("#custom_email_password").closest(\'tr\').hide();
        }
    }
</script>
'; ?>
