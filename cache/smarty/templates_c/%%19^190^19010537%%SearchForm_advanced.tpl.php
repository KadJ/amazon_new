<?php /* Smarty version 2.6.11, created on 2014-09-09 10:45:48
         compiled from cache/modules/EmailMan/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/EmailMan/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/EmailMan/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/EmailMan/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/EmailMan/SearchForm_advanced.tpl', 45, false),array('function', 'sugar_getimage', 'cache/modules/EmailMan/SearchForm_advanced.tpl', 178, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['campaign_name_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['campaign_name_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['campaign_name_advanced']['value']);  endif; ?>  
...
<?php if (strlen ( $this->_tpl_vars['fields']['to_name_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['to_name_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['to_name_advanced']['value']);  endif; ?>  
...
<?php if (strlen ( $this->_tpl_vars['fields']['to_email_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['to_email_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['to_email_advanced']['value']);  endif; ?>  
