<?php /* Smarty version 2.6.11, created on 2014-09-09 10:39:28
         compiled from cache/modules/Accounts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Accounts/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Accounts/DetailView.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/Accounts/DetailView.tpl', 44, false),array('function', 'sugar_getjspath', 'cache/modules/Accounts/DetailView.tpl', 72, false),array('function', 'sugar_phone', 'cache/modules/Accounts/DetailView.tpl', 132, false),array('function', 'sugar_ajax_url', 'cache/modules/Accounts/DetailView.tpl', 436, false),array('modifier', 'strip_semicolon', 'cache/modules/Accounts/DetailView.tpl', 58, false),array('modifier', 'substr', 'cache/modules/Accounts/DetailView.tpl', 158, false),array('modifier', 'to_url', 'cache/modules/Accounts/DetailView.tpl', 160, false),array('modifier', 'escape', 'cache/modules/Accounts/DetailView.tpl', 251, false),array('modifier', 'url2html', 'cache/modules/Accounts/DetailView.tpl', 251, false),array('modifier', 'nl2br', 'cache/modules/Accounts/DetailView.tpl', 251, false),array('modifier', 'strip_tags', 'cache/modules/Accounts/DetailView.tpl', 257, false),)), $this); ?>
...
<?php if (! empty ( $this->_tpl_vars['fields']['phone_office']['value'] )):  $this->assign('phone_value', $this->_tpl_vars['fields']['phone_office']['value']);  $this->assign('phone_name', $this->_tpl_vars['fields']['phone_office']['name']);  echo smarty_function_sugar_phone(array('value' => $this->_tpl_vars['phone_value'],'module' => $this->_tpl_vars['bean']->module_dir,'record' => $this->_tpl_vars['bean']->id,'usa_format' => '0'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['phone_office_2_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PHONE_OFFICE_2','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  class="phone">
<?php if (! $this->_tpl_vars['fields']['phone_office_2_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['phone_office_2_c']['value'] )):  $this->assign('phone_value', $this->_tpl_vars['fields']['phone_office_2_c']['value']);  $this->assign('phone_name', $this->_tpl_vars['fields']['phone_office_2_c']['name']);  echo smarty_function_sugar_phone(array('value' => $this->_tpl_vars['phone_value'],'module' => $this->_tpl_vars['bean']->module_dir,'record' => $this->_tpl_vars['bean']->id,'usa_format' => '0'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['phone_office_3_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PHONE_OFFICE_3','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  class="phone">
<?php if (! $this->_tpl_vars['fields']['phone_office_3_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['phone_office_3_c']['value'] )):  $this->assign('phone_value', $this->_tpl_vars['fields']['phone_office_3_c']['value']);  $this->assign('phone_name', $this->_tpl_vars['fields']['phone_office_3_c']['name']);  echo smarty_function_sugar_phone(array('value' => $this->_tpl_vars['phone_value'],'module' => $this->_tpl_vars['bean']->module_dir,'record' => $this->_tpl_vars['bean']->id,'usa_format' => '0'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['account_source']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_SOURCE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['account_source']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['account_source']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['account_source']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['account_source']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['account_source']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['account_source']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['account_source']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['account_source']['options'][$this->_tpl_vars['fields']['account_source']['value']]; ?>
