...
Last attempted connection @ ',
  ...
  'LBL_IMPORT_WIZARD_DESC' => 'Используйте мастер импорта для быстрого импортрования записей в систему',
...
',
  ...
  'LBL_SAML_HELP_TXT' => 'При использовании SAML-аутентификации пароли будут обрабатывться только через SAML. Все дополнительные настройки, указанные в этом разделе, будут проигнорированы.',
...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_CTI_TITLE' => 'Простые звонки',
  'LBL_CTI_DESC' => 'Интеграция с Простыми звонками',
  'LBL_CTI' => 'Подключение и настройка Простых звонков',
  'LBL_MANAGE_CTI' => 'Параметры',
  'LBL_MANAGE_ASTERISK' => 'ASTERISK Конфигурация',
  'LBL_ASTERISK' => 'Установите параметры соеденения ASTERISK',
  'LBL_ASTERISK_DESC' => 'Установите настройки необходимые для соединения с ASTERISK сервером.',
