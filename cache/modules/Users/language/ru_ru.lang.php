...
$mod_strings = array (
  ...
  'LBL_DELETE_GROUP_CONFIRM' => 'Вы действительно хотите удалить данного группового пользователя? Нажмите на кнопку <b>ОК</b> для удаления  пользователя из системы<br/>После удаления у вас будет возможность переназначить ответственных для записей, принадлежащих удаленному групповому пользователю.',
...
Если вы не настроили входящую почту - очистите все поля.',
  ...
  'LBL_SAVED_SEARCH' => 'Отображение результатов поиска / управление сохраненными условиями поиска',
  ...
  'LBL_MAX_TAB_DESCRIPTION' => 'Максимальное количество закладок, отображаемых в верхней части окна. Число отображаемых закладок зависит от разрешения экрана. Если суммарное корличество закладок превышает указанное здесь значение, то оставшиеся закладки отображаются при нажатии на значок <b>>></b>, расположенном в правой части панели навигации.',
  ...
  'LBL_PASSWORD_EXPIRATION_LOGIN' => 'Срок действия пароля истек. Укажите новый пароль.',
  ...
  'LBL_PROMPT_TIMEZONE_TEXT' => 'Запуск мастера настройки при входе в систему',
  ...
  'LBL_MARK_READ_NO' => 'E-mail помечаются удаленными после импортирования',
...
<tr><td><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com.ua/viewforum.php?f=5" target="_blank"><b>Русскоязычная документация</b></a><br>Русскоязычный форум, посвященный SugarCRM.</td></tr>
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Форум</b></a><br>Официальный форум, посвященный SugarCRM.</td></tr>
  ...
  'LBL_WIZARD_FINISH4' => 'Импорирование данных из внешних источников',
  ...
  'LBL_WIZARD_FINISH12' => 'Доступ к англоязычным учебным материалам. Ссылки на переведённую документацию вы можете посмотреть на <a href="http://www.sugarcrm.com.ua/viewforum.php?f=5" target="_blank"><b>Русскоязычном форуме, посвященном SugarCRM</b></a>.',
  ...
  'LBL_CTI_PANEL' => 'Простые звонки - настройки',
  'LBL_CTI_EXT' => 'Внутренний номер',
  'LBL_CTI_INBOUND' => 'Показывать всплывающую карточку',
  'LBL_CTI_OUTBOUND' => 'Исходящий звонок кликом',
  'LBL_ASTERISK_OPTIONS_TITLE' => 'Данные пользователя ASTERISK',
  'LBL_ASTERISK_EXT' => 'Номер телефона',
  'LBL_ASTERISK_EXT_DESC' => 'Asterisk екстеншен принадлежащий этому пользователю (обычно две\\три цифры)',
  'LBL_ASTERISK_INBOUND' => 'Уведомления о звонках',
  'LBL_ASTERISK_OUTBOUND' => 'Изображение телефончиков возле номеров телефонов',
  'LBL_ASTERISK_INBOUND_DESC' => 'Если включено, то пользователь имеет возможность видеть уведомление о входящем\\исходящем звонке.',
  'LBL_ASTERISK_OUTBOUND_DESC' => 'Если включено, то пользоваетль имеет возможность делать исходящие звонки кликом по номеру телефона.',
  'LBL_EDITVIEW_PANEL1' => 'Asterisk Connector',
);