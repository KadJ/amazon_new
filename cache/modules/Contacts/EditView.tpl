...
{capture name="label" assign="label"}{sugar_translate label='LBL_FIO_ASSIGN' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.fio_assign_c.value) <= 0}
{assign var="value" value=$fields.fio_assign_c.default_value }
{else}
{assign var="value" value=$fields.fio_assign_c.value }
{/if}  
<input type='text' name='{$fields.fio_assign_c.name}' 
id='{$fields.fio_assign_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TITLE_PDF_1' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.title_pdf_1_c.value) <= 0}
{assign var="value" value=$fields.title_pdf_1_c.default_value }
{else}
{assign var="value" value=$fields.title_pdf_1_c.value }
{/if}  
<input type='text' name='{$fields.title_pdf_1_c.name}' 
id='{$fields.title_pdf_1_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TITLE_PDF_2' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.title_pdf_2_c.value) <= 0}
{assign var="value" value=$fields.title_pdf_2_c.default_value }
{else}
{assign var="value" value=$fields.title_pdf_2_c.value }
{/if}  
<input type='text' name='{$fields.title_pdf_2_c.name}' 
id='{$fields.title_pdf_2_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TITLE_PDF_3' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.title_pdf_3_c.value) <= 0}
{assign var="value" value=$fields.title_pdf_3_c.default_value }
{else}
{assign var="value" value=$fields.title_pdf_3_c.value }
{/if}  
<input type='text' name='{$fields.title_pdf_3_c.name}' 
id='{$fields.title_pdf_3_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
addToValidate('EditView', 'title_pdf_1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TITLE_PDF_1' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'title_pdf_2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TITLE_PDF_2' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'fio_assign_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FIO_ASSIGN' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'title_pdf_3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TITLE_PDF_3' module='Contacts' for_js=true}{literal}' );
