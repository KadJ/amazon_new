...
{/if} 
<span class="sugar_field" id="{$fields.fio_assign_c.name}">{$fields.fio_assign_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{assign var="phone_name" value=$fields.phone_work.name }
{sugar_phone value=$phone_value module=$bean->module_dir record=$bean->id usa_format="0"}
{/if}
{/if}
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.title_pdf_1_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.title_pdf_1_c.name}">{$fields.title_pdf_1_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
...
{assign var="phone_name" value=$fields.phone_mobile.name }
{sugar_phone value=$phone_value module=$bean->module_dir record=$bean->id usa_format="0"}
{/if}
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.title_pdf_2_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.title_pdf_2_c.name}">{$fields.title_pdf_2_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
...
{assign var="phone_name" value=$fields.phone_fax.name }
{sugar_phone value=$phone_value module=$bean->module_dir record=$bean->id usa_format="0"}
{/if}
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.title_pdf_3_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.title_pdf_3_c.name}">{$fields.title_pdf_3_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
