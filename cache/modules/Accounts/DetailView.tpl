...
{assign var="phone_name" value=$fields.phone_office.name }
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.phone_office_2_c.hidden}
...
{if !empty($fields.phone_office_2_c.value)}
{assign var="phone_value" value=$fields.phone_office_2_c.value }
{assign var="phone_name" value=$fields.phone_office_2_c.name }
{sugar_phone value=$phone_value module=$bean->module_dir record=$bean->id usa_format="0"}
{/if}
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.phone_office_3_c.hidden}
...
{if !empty($fields.phone_office_3_c.value)}
{assign var="phone_value" value=$fields.phone_office_3_c.value }
{assign var="phone_name" value=$fields.phone_office_3_c.name }
{sugar_phone value=$phone_value module=$bean->module_dir record=$bean->id usa_format="0"}
{/if}
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.account_source.hidden}
...
{if is_string($fields.account_source.options)}
<input type="hidden" class="sugar_field" id="{$fields.account_source.name}" value="{ $fields.account_source.options }">
{ $fields.account_source.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.account_source.name}" value="{ $fields.account_source.value }">
{ $fields.account_source.options[$fields.account_source.value]}
{/if}
{/if}
</td>
{counter name="fieldsUsed"}
