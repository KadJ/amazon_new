...
$mod_strings = array (
  ...
  'LBL_SSL_DESC' => 'Если ваш почтовый сервер поддерживает SSL-соединения, то включение данной опции приведет к автоматическому созданию SSL-соединения при импорте сообщений.',
  ...
  'LBL_WARNING_CHANGING_AUTO_IMPORT_WITH_CREATE_CASE' => 'Предупреждение: При автоматическом создании Обращений автоиморт также должен быть включен.',
