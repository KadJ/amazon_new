...
$mod_strings = array (
  ...
  'LBL_EMAILTEMPLATE_MESSAGE_SHOW_MSG' => 'Выбор данного шаблона приведет к перезаписи всех данных, введённых в тело письма. Все равно продолжить?',
  ...
  'LBL_EMAILTEMPLATE_MESSAGE_MULTIPLE_RECIPIENTS' => 'Использование шаблона письма, содержащего переменные контакта (например - имя контакта), для рассылки письма сразу нескольким получателям может привести к неожиданным результатам. Рекомендуется использовать маректинговые кампании для массовой рассылки электронных писем.',
  ...
  'LBL_EMPTY_EMAIL_BODY' => '<p><span style="color: #888888;"><em> - Нет данных - </em></span></p>',
